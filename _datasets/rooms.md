...
notes: <span style='color:salmon'>Data Source</span> - This is a cleaned and formatted dataset, created by the National University of Mongolia (NUM), that includes information about the university rooms.
resources:
  - name: Rooms
    url: >-
      https://sisi.num.edu.mn/digital_num/api/package/uruunii-medeelel
    format: json
    size: '450.1 KB'
